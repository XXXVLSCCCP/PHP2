...
<head>
	...
	<title><?php $a = "minimalistica"; echo $a;  ?></title>
</head>
<body>
	<div id="content">
		<h1></h1>
		...
		$b .='<li><a href="#">archive</a></li>';
		$b .='<li><a href="#">contact</a></li>';
		$b .='</ul>';
		echo $b;
		...
		<?php
		$b = '<div class="details">';
		$b .='<h2><a href="#">Nunc commodo euismod massa quis vestibulum</a></h2>';
		$b .='<p class="info">posted 3 hours ago in <a href="#">general</a></p>';
		$b .='</div>';
		echo $b;
		...
		$c = '<div id="footer">';
			$c .= date('Y');
			$c .= '<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>';
			$c .= '</div>';
			echo $c;
